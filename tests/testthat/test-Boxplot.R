...
test_that("Boxplot with groups for test_file_1", {
  pData <- prepareData(dataPath = system.file("extdata", "test_file_1.xlsx", package = "ProtStatsWF"), intensity_columns = 3:11, use_groups = TRUE)
...
test_that("Violinplot without groups for test_file_1", {
  pData <- prepareData(dataPath = system.file("extdata", "test_file_1.xlsx", package = "ProtStatsWF"), intensity_columns = 3:11, use_groups = FALSE)
